...
const CURATED_CORE_SCAN_MARKETS = new Set(["HK", "AU", "KR", "IN"]);
...
function selectUniverseRows(snapshot = {}, options = {}) {
  ...
  // HK/AU/KR/IN: conservar orden curado→extra. El sort de materialización
  // volvería a mezclar el dump oficial por encima del núcleo líquido.
