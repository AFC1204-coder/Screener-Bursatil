...
export const FILTER_GROUPS = [
  ...
  { title: "Ratings proxy", fields: [{ key: "minAdProxyScore", label: `${metricShortLabel("adProxyScore")} min`, unit: "", step: 5, hint: "Proxy 0-100 de acumulación/distribución usando up/down volume, volumen relativo y cierre con volumen." }, { key: "minEpsGrowthProxyScore", label: `${metricShortLabel("epsGrowthProxyScore")} min`, unit: "", step: 5, hint: "Proxy 0-100 de crecimiento/calidad con beneficios, ventas, margenes y ROE si el proveedor devuelve datos." }] },
  ...
  { title: "Scores técnicos", fields: [{ key: "minWeinsteinScore", label: "Estructura tend. min", unit: "", step: 5 }, { key: "minMinerviniScore", label: "Estructura rupt. min", unit: "", step: 5 }, { key: "minMomentumScore", label: "Momentum score min", unit: "", step: 5 }, { key: "minRiskScore", label: "Risk score min", unit: "", step: 5 }, { key: "minVolumeScore", label: "Volume score min", unit: "", step: 5 }, { key: "minLiquidityScore", label: "Liquidity score min", unit: "", step: 5 }, { key: "minTotalScore", label: "Score compuesto min", unit: "", step: 5 }] },
...
// Las catorce capas arrancan encendidas. Apagar una es una decisión del
// usuario, visible en el panel de filtros; nunca un estado de fábrica.
export const DEFAULT_FILTER_LAYERS = { trend: true, momentum: true, relativeStrength: true, proximity: true, volatility: true, pattern: true, score: true, liquidity: true, volumeSurge: true, shortInterest: true, riskReward: true, coverage: true, ipo: true };
...
export const EXECUTION_LAYERS = [
  { key: "trend", label: "Tendencia", detail: "Etapa / tendencia primaria", count: 3 },
  { key: "momentum", label: "Momentum", detail: "3M, 6M, 12M", count: 4 },
  { key: "relativeStrength", label: "RS", detail: `${PRIVATE_GLOBAL_RS_DISCLOSURE}; bench/país/grupo son auxiliares`, count: 6 },
  ...
  { key: "pattern", label: "Estructura", detail: "contracciones, base y pivot", count: 11 },
  ...
  { key: "coverage", label: "Cobertura", detail: "calidad mínima de datos", count: 4 },
...
export const FILTER_FAMILY_PRESETS = {
  ...
  volumeSurge: {
    ...
    actions: [
      ...
      { label: "Acumulacion", detail: "Menos pico, más calidad de volumen.", settings: { requireUpVolume: false, minRelativeVolume: 1.1, minVolumeSurgePct: 15, minUpDownVolRatio: 1.05, minVolumeEffectScore: 25, minAdProxyScore: 55 } },
