...
export const FILTER_FAMILY_PRESETS = {
  ...
  score: {
    ...
    actions: [
      { label: "Alta calidad", detail: "Calidad objetiva y proxies exigentes.", settings: { minTotalScore: 68, minRiskScore: 50, minVolumeScore: 30, minEpsGrowthProxyScore: 35 } },
...
export const FIELD_RULES = {
  ...
  minTotalScore: { op: "min", metric: "objectiveScore", label: "calidad objetiva" },
};
