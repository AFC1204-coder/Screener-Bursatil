...
// distintos que hoy se escriben entre `raw` y `metrics`, aquí quedan 126.
//
...
// ── NIVEL 2 — los 6 interruptores de sí/no ───────────────────────────────
const BOOLEAN_RULE_FIELDS = [
  // requireStage2 → stage2RejectDetail + dailyLeaderTrendIssue
