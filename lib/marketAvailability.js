...
/**
 * Etiqueta de producto para mercados (P9): EE. UU. / Global / nombre / códigos.
...
export function buildMarketsStaleNotice({
  ...
  if (marketsSelectionPartialCoverage(scannedMarkets, selectedMarkets)) {
    ...
    const detail = `Mostrando ${mesaLabel}${rowSuffix}. Tu selección es ${seleccionLabel} — faltan en mesa: ${missingLabels}.`;
    return {
      tone: "warn",
