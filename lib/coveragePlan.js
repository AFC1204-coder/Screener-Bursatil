...
export async function buildCoverageReport({ markets = CORE_COVERAGE_MARKETS, refresh = false, maxAgeHours = 24, scanMaxRows = DEFAULT_SCAN_MAX_ROWS, scanTimeoutMs = DEFAULT_SCAN_TIMEOUT_MS, signal } = {}) {
  ...
  return {
    ...
    objective: "Cobertura maxima razonable de acciones ordinarias/vehiculos listados utiles para el analisis tecnico por etapas y estructura, excluyendo instrumentos basura, microcaps e iliquidas.",
    measurementModel: {
      ...
      actionable: "Alias legacy de rankingEligible; no representa accionabilidad metodologica.",
