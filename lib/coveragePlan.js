...
export async function buildCoverageReport({ markets = CORE_COVERAGE_MARKETS, refresh = false, maxAgeHours = 24 } = {}) {
  ...
  return {
    ...
    measurementModel: {
      ...
      rankingEligible: "Simbolos escaneados, frescos, con cobertura minima y puntuacion suficiente para aparecer en rankings/listas. No implica setup ni plan valido.",
