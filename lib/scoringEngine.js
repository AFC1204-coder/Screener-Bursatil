...
export const SIGNAL_REGISTRY = {
  ...
  patternContributionScore: {
    ...
    requiredInputs: [],
    direction: "positive",
    compute: (r) => methodologyPatternEvidenceBonus(r),
  },
  patternScore: {
    key: "patternScore",
    ...
    direction: "positive",
    compute: (r) => {
      const contribution = r.patternContribution !== undefined
 ...
 * even though compute() had no real data and degraded to 45/null.
 */
...
/** Calcula el composite (verbatim de scoreCompositeValue scoring.js L209-L224). */
