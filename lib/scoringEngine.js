...
//    NO la invoca: `row.ipoScore` queda undefined y `scoreCompositeValue`
//    lo toma como 0 vía default param. En este engine, `ipoScore` se
//    registra y se exporta, pero `lib/materializedScanner.buildResearchRow`
//    sigue sin invocarla → comportamiento observable idéntico al pre-fix.
//
...
export const SCORING_ENGINE_VERSION = "eaee4f1";
// =============================================================================
...
// ---------------------------------------------------------------------------
// Composite (declarativo). Suma de pesos = 1.00 (verbatim scoring.js L223).
// ---------------------------------------------------------------------------
...
// Suma de los pesos declarados en COMPOSITE_WEIGHTS. No es exactamente 1.0 por
// redondeo de punto flotante (0.9999999999999999) — se usa tal cual, nunca
// redondeada, para que el camino de cobertura completa (ver computeCompositeDetailed)
// pueda saltarse la división y seguir siendo bit-idéntico al cálculo original.
 ...
 *
 * Cuando todos los términos están presentes (el caso de hoy para todo excepto
 * growthScore/epsAnchor sin cobertura fundamental), el resultado es bit-idéntico
 * al cálculo literal anterior: no se ejecuta ninguna división, solo la misma
 * cadena de sumas en el mismo orden que COMPOSITE_WEIGHTS.
 *
