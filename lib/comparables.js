...
export function comparableRelationFor(item = {}, target = {}) {
  ...
  if (cleanComparableText(item.industry) && cleanComparableText(item.industry) === cleanComparableText(target.industry)) return { key: "industry", label: "Mismo subsector", rank: 1 };
