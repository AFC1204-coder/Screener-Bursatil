...
// Mercados con cohort cron de un solo mercado (HK/AU/KR/IN/CA + Europa priority):
...
const CURATED_CORE_LOOKUP_MARKETS = new Set(["HK", "AU", "KR", "IN", "CA", ...EUROPE_PRIORITY_MARKETS]);
