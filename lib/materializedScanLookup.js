...
// Mercados con cohort cron de un solo mercado (HK/AU/KR/IN): deben materializar
// ≥15 filas; por debajo de este umbral el snapshot no sustituye al nocturno US.
...
const CURATED_CORE_LOOKUP_MARKETS = new Set(["HK", "AU", "KR", "IN"]);
