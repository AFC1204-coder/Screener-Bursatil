...
export function buildFilterLayersUpgradeNotice() {
  return {
    ...
    detail: "Esta copia guardó un contrato de capas antiguo (antes de v3). Se aplicaron los valores por defecto del preset actual. Revisa en «Más filtros» qué familias opcionales quieres activar.",
    source: "filter-layers-upgrade",
  };
}
