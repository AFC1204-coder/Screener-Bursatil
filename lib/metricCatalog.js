export const METRIC_CATALOG = {
  ...
  rsGlobalPct: {
    label: "RS Universo",
    shortLabel: "RS Universo",
    description: "Percentil de fuerza relativa dentro del lote analizado con muestra minima.",
  },
  rsRating: {
    label: "RS Benchmark",
    shortLabel: "RS Bench",
    description: "Fuerza relativa frente al benchmark asignado: SPY, QQQ o ACWI.",
  },
  rsCountryPct: {
    label: "RS Pais",
    shortLabel: "RS Pais",
