...
//
// Perímetro vs rutas (C-06): proxy.js solo deja pasar x-statsedge-token o
// cookie de sesión; el navegador (lib/cloudSyncClient.js) usa la cookie.
// Bearer y x-statsedge-token aquí sirven a scripts (internalFetchHeaders) y a
// rutas cron/jobs que validan después del proxy — no al cliente en pantalla.
//
// Política:
