  ...
  return [
    ...
    },
    {
      ...
      bullets: [
        ...
        `Volumen de la fuga (solo con «${conFuga?.word || "Con fuga"}»): volumen de la primera semana con cierre por encima del techo dividido por la mediana de las ${BREAKOUT_VOL_PRIOR_WEEKS} semanas previas. Referencia visual Weinstein ≈${BREAKOUT_VOL_REFERENCE_THRESHOLD}×; no entra en la clasificación.`,
      ],
      qualifiers: [
