...
export function methodologyCopy(value = "") {
  ...
  if (text === "VCP plan valido") return "VCP plan válido";
  if (text === "Accionable") return "Plan válido";
  if (text === "Plan valido") return "Plan válido";
  ...
  if (text === "Estructura observable, sin plan valido.") return "Estructura observable, sin plan válido.";
  if (text === "Estructura observable sin plan valido.") return "Estructura observable, sin plan válido.";
  if (text === "Patron no validado como VCP estricto.") return "Patrón no validado como VCP estricto.";
  if (text === "Pivot tecnico no disponible.") return "Pivot técnico no disponible.";
  return text
