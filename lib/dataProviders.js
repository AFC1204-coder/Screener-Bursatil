...
export const PROVIDER_PLAN = [
  {
    ...
    regions: ["US", "Europa", "Hong Kong", "Japón", "Taiwán", "Australia", "Singapur", "Sudáfrica"],
  ...
  },
  {
    ...
    coverage: "EEUU, Europa y varios mercados internacionales según símbolo Stooq",
    capabilities: ["ohlcv"],
    regions: ["US", "Europa", "Japón", "Hong Kong", "Taiwán", "Australia", "Singapur", "Sudáfrica"],
    legalLimit: "Uso personal/investigación; validar licencia antes de redistribuir.",
  },
  {
    id: "nasdaq-trader",
    ...
    regions: ["US"],
    legalLimit: "Directorio publico; no contiene fundamentales ni histórico.",
  },
  {
    id: "sec-edgar",
  ...
  },
  {
    id: "alpha-vantage",
    name: "Alpha Vantage",
    role: "Fallback opcional de histórico diario",
    tier: "gratis con cuota y API key",
    status: "active",
    envKey: "ALPHA_VANTAGE_API_KEY",
    coverage: "Acciones globales según símbolo soportado por Alpha Vantage",
    capabilities: ["ohlcv"],
    regions: ["US", "Europa", "Hong Kong", "Japón", "Taiwán", "Australia", "Singapur", "Sudáfrica"],
  ...
  },
  {
    id: "openfigi",
    name: "OpenFIGI",
    role: "Normalizacion de símbolos, ISIN, FIGI, MIC y exchange",
  ...
  },
  {
    ...
    optionalKey: true,
    coverage: "Europa/EEA según ficheros ESMA FIRDS; no incluye OHLCV ni ticker Yahoo directo",
    capabilities: ["reference-universe", "isin", "mic", "instrument-classification", "openfigi-symbol-resolution"],
    regions: ["Europa", "Nordicos"],
    legalLimit: "Bueno para universo de referencia regulatorio; no sustituye feeds de precios/histórico ni derechos de redistribucion de datos de exchange.",
  },
  {
    id: "fca-firds",
    name: "FCA FIRDS",
    ...
    capabilities: ["reference-universe", "isin", "mic", "instrument-classification", "openfigi-symbol-resolution"],
    regions: ["UK"],
    legalLimit: "Fuente regulatoria de referencia; usar como universo oculto interno y exponer solo señales derivadas/frescura-gated.",
  },
  {
    id: "esef-filings",
    ...
    status: "active",
    envKey: "",
    coverage: "Europa/UK: informes anuales ESEF/UKSEF indexados por filings.xbrl.org; cobertura incompleta por país y calidad de filing",
  ...
  },
  {
    ...
    regions: ["US", "Europa", "Hong Kong", "Japón", "Taiwán", "Australia", "Singapur", "Sudáfrica"],
    legalLimit: "Cache interno de investigación; no redistribuir datos de fuentes ni saltar limites de APIs/exchanges.",
  },
  {
  ...
  },
  {
    ...
    role: "Cobertura prudente de Canada, Singapur y Sudáfrica; India/Israel quedan diferidos",
    tier: "interno/gratis",
    status: "active",
    envKey: "",
    coverage: "Canada TSX core, Singapur SGX core y Sudáfrica JSE core por símbolos publicos de alta liquidez; India/Israel solo manual/backlog",
    capabilities: ["universe", "watchlist-seed", "derived-rankings"],
    regions: ["Canada", "Singapur", "Sudáfrica", "India deferred", "Israel deferred"],
  ...
  },
  {
    id: "jquants",
    name: "J-Quants",
    role: "Universo, OHLCV, fundamentales y short-selling sectorial Japón",
    tier: "free/low-cost según plan",
    status: "active-when-configured",
    envKey: "JQUANTS_API_KEY",
    coverage: "Japón/TSE; Universe Engine usa V2 /equities/master con API key o V1 listed/info con refresh token",
    capabilities: ["universe", "ohlcv", "fundamentals", "short-selling"],
    regions: ["Japón"],
    legalLimit: "Usar como cache interno y señales derivadas; validar plan y redistribucion antes de publicar datos a terceros.",
  },
  {
  ...
  },
  {
    ...
    role: "Universo Taiwán",
    tier: "gratis publico",
    status: "active",
    envKey: "",
    coverage: "Taiwán/TWSE: acciones listadas oficiales; se filtran common-equity CFI rows para símbolos .TW",
  ...
  },
  {
    ...
    regions: ["US", "Europa", "Hong Kong", "Japón", "Taiwán", "Australia", "Singapur", "Sudáfrica"],
    legalLimit: "Validar plan comercial/display antes de usar fuera de investigación personal.",
  },
  {
    id: "finnhub",
    name: "Finnhub",
    ...
    regions: ["US", "Europa"],
    legalLimit: "Free tier útil para prototipo; revisar licencia si hay producto publico.",
  },
  {
    id: "twelve-data",
    name: "Twelve Data",
    role: "Fallback global de precio/histórico",
    tier: "gratis limitado con API key",
    status: "planned-premium-candidate",
    envKey: "TWELVE_DATA_API_KEY",
    coverage: "Acciones, ETFs y divisas según mercado soportado",
  ...
  },
  {
    id: "marketstack",
    name: "Marketstack",
    role: "Histórico EOD global opcional",
    tier: "gratis limitado con API key",
    status: "planned-premium-candidate",
...
function parseAlphaDaily(data = {}, alphaSymbol = "", originalSymbol = "") {
  ...
  if (!bars.length) throw new Error("Alpha Vantage sin histórico útil");
  return {
    bars,
    meta: {
