...
export const LEADERBOARD_STRATEGIES = {
  ...
  rs: {
    label: "RS Universo",
    description: "Mayor fuerza relativa de universo disponible; el benchmark queda como senal secundaria cuando no hay muestra.",
  },
  growth: {
...
export const DEFAULT_LEADERBOARD_SPECS = [
  ...
  { key: "global-rs", title: "Top RS Universo", strategy: "rs", scopeType: "global", scopeValue: "" },
...
export function buildLeaderboard(rows = [], params = {}) {
  ...
  const screenerFilters = screenerFiltersFromParams(params);
