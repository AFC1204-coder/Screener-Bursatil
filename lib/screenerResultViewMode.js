...
export const SCREENER_RESULT_VIEW_MODE_CHANGED_EVENT = "statsedge:screenerResultViewMode";
...
export function persistResultViewMode(mode) {
  if (mode === RESULT_VIEW_MODES.CAZA || mode === RESULT_VIEW_MODES.AUDIT) {
    ...
    if (typeof window !== "undefined") {
      window.dispatchEvent(new CustomEvent(SCREENER_RESULT_VIEW_MODE_CHANGED_EVENT, { detail: mode }));
    }
  }
}
