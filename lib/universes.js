...
export const EXTRA_UNIVERSES = {
  ...
  FI: ["ELISA.HE", "KESKOB.HE", "ORNBV.HE", "OUT1V.HE", "VALMT.HE", "WRT1V.HE", "HIAB.HE", "KCR.HE", "TYRES.HE", "HUH1V.HE", "CGCBV.HE", "ALMA.HE", "TAALA.HE", "OLVAS.HE", "TOIVAS.HE", "TOKMAN.HE", "DETEC.HE"],
  BE: ["AGEAS.BR", "COFB.BR", "MELE.BR", "ACKB.BR", "TNET.BR", "BAR.BR", "WDP.BR", "ELI.BR", "DIEL.BR", "AZE.BR", "EVS.BR", "PROX.BR", "ECONB.BR", "VGP.BR", "LOTB.BR", "ONTEX.BR", "CDLOB.BR", "RECT.BR"],
  PT: ["SON.LS", "NOS.LS", "ALT.LS", "RAM.LS", "NVG.LS", "SEM.LS", "CTT.LS", "MEO.LS", "ALTR.LS", "RED.LS", "CAP.LS", "GLPG.LS", "FII.LS", "COR.LS", "SLB.LS", "HRB.LS", "IPR.LS", "SNC.LS"],
  AT: ["RBI.VI", "WIE.VI", "CAIV.VI", "EVN.VI", "WLS.VI", "POST.VI", "LNZ.VI", "MMK.VI", "BG.VI", "SPI.VI", "VIG.VI", "LEN.VI", "SBO.VI", "TKA.VI", "UMQ.VI", "PAL.VI", "WOLF.VI", "DOC.VI"],
  IE: ["AIBG.IR", "BIRG.IR", "DCC.IR", "GL9.IR", "ICG.IR", "KRX.IR", "PTSB.IR", "DOCC.IR", "FBD.IR", "ORIT.IR", "ORIG.IR", "GLV.IR", "5G.IR", "KSP.IR", "EG7.IR"],
  ...
  KR: [
    "005930.KS", "000660.KS", "005380.KS", "000270.KS", "035420.KS", "035720.KS", "051910.KS", "006400.KS", "068270.KS", "207940.KS",
    "105560.KS", "055550.KS", "086790.KS", "066570.KS", "012330.KS", "028260.KS", "032830.KS", "015760.KS", "017670.KS", "009150.KS",
    "010130.KS", "033780.KS", "018260.KS", "000810.KS", "003550.KS", "034730.KS", "009540.KS", "247540.KS",
  ],
...
export const CURATED_NAMES = {
  ...
  "AIBG.IR": "AIB Group", "BIRG.IR": "Bank of Ireland", "DCC.IR": "DCC", "GL9.IR": "Glanbia", "ICG.IR": "ICG", "KRX.IR": "Kingspan", "PTSB.IR": "Permanent TSB", "DOCC.IR": "Smurfit WestRock", "FBD.IR": "FBD Group", "ORIT.IR": "Irish Residential Properties REIT", "ORIG.IR": "Origin Enterprises",
  "AGEAS.BR": "Ageas", "COFB.BR": "Cofinimmo", "MELE.BR": "Melexis", "ACKB.BR": "Ackermans Van Haaren", "TNET.BR": "Telenet", "BAR.BR": "Barry Callebaut", "WDP.BR": "WDP", "ELI.BR": "Elia Group",
  "SON.LS": "Sonae", "NOS.LS": "NOS", "ALT.LS": "Altice Portugal", "RAM.LS": "Rami", "NVG.LS": "Navigator", "SEM.LS": "Semapa", "CTT.LS": "CTT Correios", "MEO.LS": "MEO",
  "RBI.VI": "Raiffeisen Bank International", "WIE.VI": "Wienerberger", "CAIV.VI": "CA Immobilien", "EVN.VI": "EVN", "WLS.VI": "Wiener Staedtische", "POST.VI": "Oesterreichische Post", "LNZ.VI": "Lenzing", "MMK.VI": "MM Group",
  ...
  "005930.KS": "Samsung Electronics", "000660.KS": "SK Hynix", "005380.KS": "Hyundai Motor", "000270.KS": "Kia", "035420.KS": "NAVER", "035720.KS": "Kakao", "051910.KS": "LG Chem", "006400.KS": "Samsung SDI", "068270.KS": "Celltrion", "207940.KS": "Samsung Biologics",
  "105560.KS": "KB Financial Group", "055550.KS": "Shinhan Financial Group", "086790.KS": "Hana Financial Group", "066570.KS": "LG Electronics", "012330.KS": "Hyundai Mobis", "028260.KS": "Samsung C&T", "032830.KS": "Samsung Life Insurance", "015760.KS": "Korea Electric Power", "017670.KS": "SK Telecom", "009150.KS": "Samsung Electro-Mechanics",
  "010130.KS": "Korea Zinc", "033780.KS": "KT&G", "018260.KS": "Samsung SDS", "000810.KS": "Samsung Fire & Marine Insurance", "003550.KS": "LG Corp", "034730.KS": "SK", "009540.KS": "HD Hyundai Heavy Industries", "247540.KS": "EcoPro BM",
};
...
export function exchangeLabel(symbol, country) {
  ...
  if (symbol.endsWith(".TW")) return "Taiwán";
...
export async function fetchUSUniverse() {
  ...
  for (const url of urls) {
    ...
    for (const line of lines.slice(1)) {
      ...
      const listingExchange = String(row["Listing Exchange"] || row.Exchange || "").trim().toUpperCase();
      const marketCategory = String(row["Market Category"] || "").trim().toUpperCase();
      const micCode = listingExchange === "N" ? "XNYS"
        : listingExchange === "A" ? "XASE"
          : listingExchange === "P" ? "ARCX"
            : listingExchange === "Z" ? "BATS"
              : listingExchange === "Q" && marketCategory === "Q" ? "XNGS"
                : listingExchange === "Q" && marketCategory === "G" ? "XNMS"
                  : listingExchange === "Q" && marketCategory === "S" ? "XNCM"
                    : "";
      out.push({
        ...
        country: "US",
        micCode,
        source: "NasdaqTrader symbol directories",
      });
    }
  }
