const CONTRACTS = {
  ...
  watch: {
    ...
    text: "Resultados para seguimiento: la accion puede ser fuerte, cercana a pivot, pullback, IPO o extendida; no implica plan automatico.",
    okText: "Coherencia de vigilancia activa: el resultado queda separado de una lista de largos ejecutables.",
  },
  bearish: {
    tone: "bearish",
    label: "Deterioro",
    title: "Debilidad tecnica",
    text: "Resultados defensivos o bajistas: este contrato no es una lista de largos y debe quedar separado de lideres.",
    okText: "Coherencia de deterioro activa: la salida queda etiquetada como debilidad, no como oportunidad larga.",
  },
  exploratory: {
    tone: "exploratory",
    label: "Exploratorio",
    title: "Diagnostico amplio",
    text: "Resultados para exploracion y auditoria: pueden aparecer estructuras mixtas; no deben leerse como Minervini, leaders o largos limpios.",
    okText: "Coherencia exploratoria activa: la salida queda marcada como diagnostico, no como lista operativa.",
  },
};
