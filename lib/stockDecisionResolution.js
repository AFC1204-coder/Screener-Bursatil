...
export const STOCK_DECISION_VALIDATION_STATES = [
  ...
  { key: "pending", label: "Pendiente", tone: "warn", detail: "La prueba sigue sin confirmar o necesita mas espera." },
  { key: "blocked", label: "Bloquea", tone: "bad", detail: "La prueba invalida o bloquea la decision." },
];
