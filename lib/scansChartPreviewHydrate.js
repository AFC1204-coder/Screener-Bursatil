...
/**
 * Símbolos missing de chartPreview para el plan de hydrate.
 * En modo Caza pasar solo `huntRows` (ventana viewport+buffer); no concatenar
 * mesa/`pagedRows` ni quickReview — al entrar a Caza eso unía ~página+ventana
 * y disparaba el techo 80 (CAZA-CHARTPREVIEW-ENTRY-1).
 */
