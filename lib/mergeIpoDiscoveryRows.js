// lib/mergeIpoDiscoveryRows.js — utilidades vigiladas pre-IPO (IPO-1c); merge desconectado en IPO-UX-A.
...
export function augmentIpoDiscoveryFilteredView(filteredView = {}) {
  // IPO-UX-A: la lente cohort solo muestra filas de scan; sin vigiladas pre-IPO.
  return filteredView;
}
