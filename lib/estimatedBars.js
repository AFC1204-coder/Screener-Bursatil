...
export function estimatedChartForSymbol(symbol = "", options = {}, error = {}) {
  ...
  // demo: la serie se sirvió porque el caller pidió modo demo (datos sintéticos
  // mostrados deliberadamente, no un fallback por fallo del proveedor). De
  // momento llega como parámetro con default false; el wiring real (paso 4)
  // lo propagará desde el caller que sabe si está en modo demo.
