...
export const LIST_CONTRACTS = {
  ...
  leaders: {
    title: "Calidad objetiva",
    tone: "bullish",
    label: "Largo coherente",
    text: "Calidad objetiva alta con sesgo largo; excluye deterioro técnico y bajismo estructural.",
  },
  rsQuality: {
...
export function listInclusionReasons(row = {}, listKey = "leaders", limit = 4) {
  ...
  if (listKey === "rsQuality") {
    ...
    pushMetric(reasons, "Calidad objetiva", metric(row, "objectiveScore"));
    pushMetric(reasons, "RS", metric(row, "rsGlobalPct"));
