...
/** Non-production + token configurado: el servidor puede emitir cookie sin pegar el hex. */
export function isLocalUnlockAllowed() {
  return process.env.NODE_ENV !== "production" && Boolean(appAccessToken());
}

export function isLocalUnlockHost(hostname = "") {
