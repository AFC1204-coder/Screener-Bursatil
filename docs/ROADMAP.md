# Roadmap estratégico — StatsEdge

> Fecha: 2026-05-29 · Estado: borrador para discusión
> Documentos relacionados: [`data-providers.md`](./data-providers.md) ·
> [`methodology/market-leadership-framework.md`](./methodology/market-leadership-framework.md) ·
> [`v1-functional-consolidation-plan.md`](./v1-functional-consolidation-plan.md)
...
- **Precios:** Yahoo Finance **no oficial** como fuente principal (ver [`data-providers.md`](./data-providers.md),
  estrategia "free-first" válida para V1 pero **no para SaaS de pago**). Sin licencia comercial → **riesgo legal
  y de ruptura**. Fallbacks (Stooq, Alpha Vantage) requieren config manual.
...
3. **Planes/monetización:** free vs pro (límite de scans, mercados, alertas), Stripe.
