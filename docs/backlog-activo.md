...
**Ahora:** **REVIEW-HYDRATE-DEFER-1** prep (Astra cerrado: A1-S · A2-CHART · A3-OMIT · A5-ABSENT).  
**Cola:** DEFER-1 → CHART-PARALLEL / PERSIST-PREVIEW · aparcados remount/theme/chartPreview-bootstrap/react-commit.  
