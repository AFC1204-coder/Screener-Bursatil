...
**Ahora:** idle · **REVIEW-HYDRATE-DEFER-1 ACCEPT** (Astra A1-S/A2-CHART/A3-OMIT/A5).  
**Cola:** REVIEW-CHART-PARALLEL-1 · REVIEW-PERSIST-PREVIEW-1 · aparcados remount/theme/chartPreview-bootstrap/react-commit.  
