...
function baseBag(resultsRows, pendingResults) {
  return {
    chrome: { presetKey: "global", markets: [["US", "EE. UU."]], filtered: [], filteredCount: 0, running: false, err: null, status: "idle", snapshotNotice: null, showMobileFilters: false, sidebarCollapsed: false, setShowMobileFilters: () => {}, setSidebarCollapsed: () => {}, stopScan: () => {}, run: () => {}, kpiUniverseCount: 0, marketHealth: null, rows: resultsRows },
    ...
    actions: { openReview: () => {}, saveSnapshot: () => {}, csv: () => {}, decisionAuditJson: () => {}, commitPendingResults: () => {}, resetScreenerSession: () => {}, addFavorite: () => {}, saveSessionBeforeStockOpen: () => {} },
