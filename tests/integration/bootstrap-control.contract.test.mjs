...
test("ephemeral harness inventory declares exactly nine isolated databases", () => {
  assert.equal(EPHEMERAL_DATABASE_INVENTORY.length, 9);
  assert.equal(new Set(EPHEMERAL_DATABASE_INVENTORY).size, 9);
});
