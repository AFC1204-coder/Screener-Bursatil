...
export function resultPayload(row = {}, scanId, ownerId, index, settingsOrExplanation = {}) {
  ...
  return {
    ...
    metrics: {
      ...
      weeklyStageStructure: preparedRow.weeklyStageStructure ?? null,
      weeklyStageStructureLabel: preparedRow.weeklyStageStructureLabel ?? null,
      weeklyStageStructureDetail: preparedRow.weeklyStageStructureDetail ?? null,
      weeklyResistance: preparedRow.weeklyResistance ?? null,
      weeklyResistanceDate: preparedRow.weeklyResistanceDate ?? null,
      weeklyDistResistancePct: preparedRow.weeklyDistResistancePct ?? null,
      weeklyRng26Pct: preparedRow.weeklyRng26Pct ?? null,
      weeklyRuptura: preparedRow.weeklyRuptura ?? null,
      weeklyHhHl: preparedRow.weeklyHhHl ?? null,
      weeklyBreakoutVolRatio: preparedRow.weeklyBreakoutVolRatio ?? null,
      weeklyBreakoutVolWeek: preparedRow.weeklyBreakoutVolWeek ?? null,
      weeklyBreakoutVolDetail: preparedRow.weeklyBreakoutVolDetail ?? null,
