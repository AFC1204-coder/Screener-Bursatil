...
import { buildScreenerFilterExplainPlan, screenerFilterRejectReason as sharedScreenerFilterRejectReason } from "@/lib/screenerFilters";
...
const SECTOR_STRENGTH_LABELS = {
  Debiles: "Débiles",
  "Muy debiles": "Muy débiles",
  Débiles: "Débiles",
  "Muy débiles": "Muy débiles",
};
function normalizeSectorStrength(value = "Todos") {
  if (value === "Débiles") return "Debiles";
  if (value === "Muy débiles") return "Muy debiles";
  return value || "Todos";
}
