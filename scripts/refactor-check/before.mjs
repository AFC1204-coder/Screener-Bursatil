// AUTOGENERADO para verificación del refactor: copias VERBATIM de app/page.jsx (pre-refactor)
...
export { avg, avgWithCoverage, clamp, finiteNumber, firstFinite, sma, perf, hiLo, highValue, highDist, lowAdv, stdev, dailyReturns, annualizedVolatility, downsideVolatility, maxDrawdown, maxDailyMovePct, dailyRangePcts, maxDailyRangePct, avgDailyRangePct, priceRangePct, riskAdjustedStats, udVol, avgVolume, monthsSince, ipoAgeMonthsForRow, gt, gte, lt, lte, between, rsPrimaryScore, isStage2, scoreWeinstein, scoreMinervini, scoreMomentum, scoreRisk, scoreRiskReward, scoreWeakness, scoreVolumeEffect, volumeEvidence, scoreVolume, scoreLiq, scoreIpo, scoreSetupQuality, scoreDemandQuality, scoreGrowthQuality, scoreEpsGrowthProxy, scoreAdProxy, compositeLabel, compositeNarrative, REJECTION_META, rejectReason, regimeRejectReason, regimeFiltered, objectiveStage };
